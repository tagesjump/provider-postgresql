...
// GetInitParameters of this ReplicationSlot
func (tr *ReplicationSlot) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this ReplicationSlot
func (tr *ReplicationSlot) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
